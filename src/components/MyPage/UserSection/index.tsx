...
export const UserSection = ({ profileImage, nickName }: UserSectionProps) => {
  return (
    <section className="mt-12 mb-7 flex flex-col justify-center items-center">
      ...
      <span className="inline-block mb-5  text-main font-semibold text-white">{`안녕하세요, ${nickName}님`}</span>
      <Link
